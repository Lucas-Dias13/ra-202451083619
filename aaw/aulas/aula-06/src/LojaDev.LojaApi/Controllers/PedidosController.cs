...
public class PedidosController : ControllerBase
{
    ...
    public async Task<IActionResult> CriarPedidoSincrono([FromBody] Pedido pedido)
    {
        ...
        var bodyNotificacao = new
        {
            ...
            Assunto = $"Pedido {pedido.Id} aprovado",
            Corpo = $"Seu pedido de {pedido.Produto} no valor de {pedido.Valor:C} foi aprovado!"
        };
        ...
        try
        {
            ...
            statusNotificacao = respostaNotif.IsSuccessStatusCode ? "enviada" : "falha";
        }
